...
3. **Agar joined nahi hai:**
   ...
   - Use ek message milta hai jisme sabhi channels ke "Join" button hote hain,
     saath me ek **"✅ Maine Join Kar Liya"** button hota hai
4. Jab user sabhi channels join karke us button ko dabata hai:
   - Bot dobara check karta hai
   - Agar sab join ho gaye → **unmute** ho jata hai aur ab wo group me
     message bhej sakta hai
   - Agar abhi bhi koi channel baaki hai → bot bata deta hai
